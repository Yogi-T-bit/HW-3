...
public class EnumContainer {
    ...
    public static enum Breed {THOROUGHBRED, STANDARDBRED, MORGAN, FRIESIAN}
    ...
    public static enum Engine {FOURSTROKE, VTYPE, STRAIGHT, BOXER, ROTARY}

    public static enum BicycleType {MOUNTAIN, HYBRID, CRUISER, ROAD}


    public static enum Team {SINGLE, DOUBLE, QUAD, EIGHT}
